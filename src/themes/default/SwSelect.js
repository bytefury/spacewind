export default {
  classes: {
    ...
    multiselectTag:
      'multiselect__tag relative inline-block pt-1 pr-6 pb-1 pl-2 rounded mr-2 text-white leading-none my-0.5 whitespace-no-wrap overflow-hidden max-w-full bg-primary-500',
    multiselectTagIcon:
