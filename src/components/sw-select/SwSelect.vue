  ...
  >
    <slot :toggle="toggle" name="caret">
      <div :class="multiselectSelectStyle" @mousedown.prevent.stop="toggle()">
        <span
          class="relative right-0 top-1/2"
          style="color: '#a5acc1'; margin-top: 4px; border-color: #a5acc1 transparent transparent; border-style: solid; border-width: 5px 5px 0; content: ''"
        ></span>
      </div>
    </slot>
          ...
          <template v-for="(option, index) of visibleValues" @mousedown.prevent>
            ...
            >
              <span :key="index" :class="multiselectTagStyle">
                ...
                >
                  <span class="multiselect__tag-icon-after">×</span>
                </span>
              </span>
            </slot>
          </template>
